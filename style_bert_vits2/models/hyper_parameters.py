...
from style_bert_vits2.nlp.symbols import DURATION_SYMBOL_TYPE_COUNT
...
class HyperParametersModel(BaseModel):
    ...
    use_duration_symbol_type_embedding: bool = False
    duration_symbol_type_count: int = DURATION_SYMBOL_TYPE_COUNT
