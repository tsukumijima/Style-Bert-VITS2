...
# Transformer-based DP/SDP へ渡す duration 専用記号種別
## 音素 ID は個々の記号を表し、こちらは休止・境界・絵文字制御の粗い性質だけを表す
## 値を変更すると学習済み duration_symbol_type_emb の意味が変わるため、既存値の並び替えは禁止
DURATION_SYMBOL_TYPE_CONTENT = 0
DURATION_SYMBOL_TYPE_BLANK = 1
DURATION_SYMBOL_TYPE_COMMA = 2
DURATION_SYMBOL_TYPE_PERIOD = 3
DURATION_SYMBOL_TYPE_ELLIPSIS_DOT = 4
DURATION_SYMBOL_TYPE_QUESTION = 5
DURATION_SYMBOL_TYPE_EXCLAMATION = 6
DURATION_SYMBOL_TYPE_QUOTE_BOUNDARY = 7
DURATION_SYMBOL_TYPE_HYPHEN = 8
DURATION_SYMBOL_TYPE_EVENT_EMOJI = 9
DURATION_SYMBOL_TYPE_PROSODY_MARKER_EMOJI = 10
DURATION_SYMBOL_TYPE_NAMES = [
    "content",
    "blank",
    "comma",
    "period",
...
DURATION_SYMBOL_TYPE_COUNT = len(DURATION_SYMBOL_TYPE_NAMES)
