...
def get_path_config() -> PathConfig:
    path_config_path = Path("/root/configs/paths.yml")
    if not path_config_path.exists():
        shutil.copy(src="/root/configs/default_paths.yml", dst=path_config_path)
        logger.info(
            f"A configuration file {path_config_path} has been generated based on the default configuration file default_paths.yml."
        )
        logger.info("Please do not modify configs/default_paths.yml. Instead, modify configs/paths.yml.")
